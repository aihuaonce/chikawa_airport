...
class AppTranslations {
  ...
  // ========== Plan Page 額外翻譯 (只添加不存在的) ==========
  
  // Voice input (新)
  String get voiceInputInstruction => isZh ? '這裡依序輸入體溫、脈搏、呼吸、血壓、血氧、血糖' : 'Enter temperature, pulse, respiration, blood pressure, SpO2, blood sugar in order';
  
  // Screening methods (新)
  String get infraredThermometer => isZh ? '額溫槍' : 'Infrared Thermometer';
  String get earThermometer => isZh ? '耳溫槍' : 'Ear Thermometer';
  
  // Main symptoms (新，trauma已存在)
  String get mainSymptom => isZh ? '主要症狀' : 'Main Symptom';
  
  // Body parts (新，chest/abdomen/limbs已存在)
  
  // Symptom note (新)
  String get supplementaryNote => isZh ? '補充說明' : 'Supplementary Note';
  String get fillSupplementaryNote => isZh ? '填寫主訴補充說明' : 'Fill in supplementary note for chief complaint';
  
  // Photo types (新)
  String get traumaPhoto => isZh ? '外傷照片' : 'Trauma Photo';
  String get ekgPhoto => isZh ? '心電圖照片' : 'ECG Photo';
  String get otherPhoto => isZh ? '其他照片' : 'Other Photo';
  
  // Physical examination (新)
  String get enterExaminationInfo => isZh ? '請輸入檢查資訊' : 'Please enter examination information';
  
  // Vital signs (temperatureLabel等已存在，這裡添加簡短版本)
  String get enterNumber => isZh ? '輸入數字' : 'Enter number';
  String get enterInteger => isZh ? '輸入整數' : 'Enter integer';
  String get integer => isZh ? '整數' : 'Integer';
  
  // Consciousness (新)
  String get consciousnessClear => isZh ? '意識清晰' : 'Consciousness Clear';
  
  // Pupil (新)
  String get leftPupil => isZh ? '左瞳孔' : 'Left Pupil';
  String get rightPupil => isZh ? '右瞳孔' : 'Right Pupil';
  String get normalReaction => isZh ? '正常反應' : 'Normal Reaction';
  String get slowReaction => isZh ? '反應遲鈍' : 'Slow Reaction';
  String get noReaction => isZh ? '無反應' : 'No Reaction';
  
  // Medical history (新)
  String get checkIfYes => isZh ? '有請打勾' : 'Check if yes';
  String get fillAllergyInfo => isZh ? '填寫過敏資訊' : 'Fill in allergy information';
  
  // Diagnosis (新)
  String get fillPreliminaryDiagnosis => isZh ? '請填寫初步診斷' : 'Please fill in preliminary diagnosis';
  String get secondaryDiagnosisICD10 => isZh ? '副診斷1的ICD-10' : 'Secondary Diagnosis 1 ICD-10';
  String get secondaryDiagnosis2ICD10 => isZh ? '副診斷2的ICD-10' : 'Secondary Diagnosis 2 ICD-10';
  String get selectICD10 => isZh ? '選擇ICD-10' : 'Select ICD-10';
  
  // Triage (新)
  String get triageLevel1 => isZh ? '第一級：復甦急救' : 'Level 1: Resuscitation';
  String get triageLevel2 => isZh ? '第二級：危急' : 'Level 2: Emergent';
  String get triageLevel3 => isZh ? '第三級：緊急' : 'Level 3: Urgent';
  String get triageLevel4 => isZh ? '第四級：次緊急' : 'Level 4: Less Urgent';
  String get triageLevel5 => isZh ? '第五級：非緊急' : 'Level 5: Non-Urgent';
  
  // Treatment summary items (新)
  String get icePack => isZh ? '冰敷' : 'Ice Pack';
  String get ekgECG => isZh ? 'EKG心電圖' : 'EKG/ECG';
  String get woundCare => isZh ? '傷口處置' : 'Wound Care';
  String get signQuadruplicate => isZh ? '簽四聯單' : 'Sign Quadruplicate Form';
  String get recommendReferral => isZh ? '建議轉診' : 'Recommend Referral';
  String get medicationUse => isZh ? '藥物使用' : 'Medication Use';
  
  // ECG & Blood Sugar (新)
  String get fillEKGReading => isZh ? '請填寫判讀結果' : 'Please fill in reading result';
  String get bloodSugarMgdL => isZh ? '血糖(mg/dL)' : 'Blood Sugar (mg/dL)';
  String get fillBloodSugarRecord => isZh ? '請填寫血糖記錄' : 'Please fill in blood sugar record';
  
  // Referral section (新)
  String get normalPassage => isZh ? '一般通關' : 'Normal Passage';
  String get fillOtherHospitalName => isZh ? '請填寫其他醫院名稱' : 'Please fill in other hospital name';
  String get fillEscortPersonnel => isZh ? '請填寫陪同人員' : 'Please fill in escort personnel';
  
  // Oxygen therapy (新)
  String get fillOxygenFlow => isZh ? '請填寫氧氣流量' : 'Please fill in oxygen flow';
  
  // Prescription (新)
  String get addPrescriptionRecord => isZh ? '新增藥物記錄' : 'Add Prescription Record';
  String get usageMethod => isZh ? '使用方式' : 'Usage Method';
  String get remark => isZh ? '備註' : 'Remark';
  
  // Follow-up results (新)
  String get transferToOtherHospital => isZh ? '轉其他醫院' : 'Transfer to Other Hospital';
  
  // Staff section (新)
  String get selectDoctorName => isZh ? '點擊選擇醫師的姓名（必填）' : 'Click to select doctor\'s name (required)';
  String get selectNurseName => isZh ? '點擊選擇護理師的姓名（必填）' : 'Click to select nurse\'s name (required)';
  String get selectEMTName => isZh ? '點擊選擇EMT的姓名' : 'Click to select EMT\'s name';
  String get fillAssistantStaffName => isZh ? '請填寫協助人員的姓名' : 'Please fill in assistant staff name';
  String get noAssistantSelected => isZh ? '尚未選擇協助人員' : 'No assistant staff selected';
  String get addAssistantStaff => isZh ? '加入協助人員' : 'Add Assistant Staff';
  String get selectAssistantStaff => isZh ? '選擇協助人員姓名' : 'Select Assistant Staff Name';
  
  // Special notes (新)
  
  // Dialog related (新)
  String get selectDoctor => isZh ? '選擇醫師' : 'Select Doctor';
  String get selectNurse => isZh ? '選擇護理師' : 'Select Nurse';
  String get selectEMT => isZh ? '選擇EMT' : 'Select EMT';
  
  // Helper function for ICD-10 code hint (新)
  String fillICD10CodeHint(String diagnosisName) => isZh ? '請填寫 $diagnosisName 的ICD-10代碼' : 'Please fill in $diagnosisName ICD-10 code';
  
  // ========== Undertaking Page (切結書頁面) ==========
  String get saveUndertakingFailed => isZh ? '儲存切結書失敗: ' : 'Failed to save undertaking: ';
  String get resignButton => isZh ? '重簽' : 'Re-sign';
  String get rewriteButton => isZh ? '重寫' : 'Rewrite';
  String get confirmSignature => isZh ? '確認簽名' : 'Confirm Signature';
  String get signatureSaved => isZh ? '簽名已暫存' : 'Signature saved temporarily';
  
  // English undertaking text
  String undertakingEnglishText(String signerName, String doctor) => 
    "I: $signerName\n"
    "Date of birth\n"
  ...
  String get signatureLabel => isZh ? '簽名:' : 'Signature:';
  
  // Chinese undertaking text
  String get undertakingPersonLabel => isZh ? '本人：' : 'Person:';
  String get idNumberLabel => isZh ? '身分證字號：' : 'ID Number:';
  
  String undertakingChineseIntro(String today, String doctor) => isZh 
    ? '$today 於桃園國際機場接受聯新國際醫院桃園國際機場醫療中心醫師'
    : '$today at Taiwan Taoyuan International Airport, received consultation from Dr. $doctor of Landseed Medical Clinic at Taiwan Taoyuan Int\'l Airport Medical Center';
  
  String get undertakingChineseContent => isZh 
    ? '診視，醫師建議轉診至醫院繼續治療，但本人因個人因素拒絕醫師「繼續治療」之建議，致生一切後果願自行負責,與聯新國際醫院桃園國際機場醫療中心無涉。'
    : 'After consultation, the doctor recommended referral to a hospital for continued treatment, but I personally refused the doctor\'s recommendation for "continued treatment" due to personal reasons. I am willing to take full responsibility for all consequences, which are unrelated to Landseed International Hospital Taiwan Taoyuan International Airport Medical Center.';
  
  String get isSelfQuestion => isZh ? '是否為本人？' : 'Is this the person themselves?';
  String get undertakingSignerName => isZh ? '立切結書人姓名：' : 'Undertaking Signer Name:';
  String get enterSignerName => isZh ? '請輸入姓名' : 'Please enter name';
  String get undertakingSignerId => isZh ? '立切結書人身分證字號：' : 'Undertaking Signer ID Number:';
  String get enterSignerIdNumber => isZh ? '請輸入身分證字號' : 'Please enter ID number';
  String get undertakingSignerRelation => isZh ? '立切結書人與病患關係：' : 'Undertaking Signer\'s Relation to Patient:';
  String get enterRelationExample => isZh ? '例如：本人、父母、配偶' : 'e.g., Self, Parent, Spouse';
  String get undertakingSignerAddress => isZh ? '立切結書人地址：' : 'Undertaking Signer Address:';
  String get enterSignerAddress => isZh ? '請輸入地址' : 'Please enter address';
  String get undertakingSignerPhone => isZh ? '立切結書人電話：' : 'Undertaking Signer Phone:';
  String get enterSignerPhone => isZh ? '請輸入聯絡電話' : 'Please enter contact number';
  String get selfRelation => isZh ? '本人' : 'Self';
  
  // ========== ReferralForm Page (轉診單頁面) ==========
  String get referralFormTitle => isZh ? '轉診單' : 'Referral Form';
  
  // Left Card 1
  String get contactInformation => isZh ? '聯絡人資訊' : 'Contact Information';
  String get contactPhone => isZh ? '聯絡人電話：' : 'Contact Phone:';
  String get contactAddress => isZh ? '聯絡人地址：' : 'Contact Address:';
  
  // Right Card 1
  String get diagnosisInformation => isZh ? '診斷資訊' : 'Diagnosis Information';
  String get mainDiagnosisLabel => isZh ? '主診斷：' : 'Main Diagnosis:';
  String get enterMainDiagnosis => isZh ? '請填寫主診斷' : 'Please enter main diagnosis';
  String get subDiagnosisLabel => isZh ? '副診斷：' : 'Sub Diagnosis:';
  String get enterSubDiagnosis => isZh ? '請填寫副診斷' : 'Please enter sub diagnosis';
  
  // Left Card 2
  String get treatmentInformation => isZh ? '治療資訊' : 'Treatment Information';
  String get lastExamDate => isZh ? '最近一次檢查日期' : 'Last Examination Date';
  String get lastMedicationDate => isZh ? '最近一次用藥日期' : 'Last Medication Date';
  
  // Right Card 2
  String get inpatientTreatment => isZh ? '住院治療' : 'Inpatient Treatment';
  String get returnForFollowup => isZh ? '轉回轉出或適當之院所繼續追蹤' : 'Return to Referring or Appropriate Hospital for Follow-up';
  String get examItems => isZh ? '檢查項目：' : 'Exam Items:';
  String get enterExamItems => isZh ? '請填寫檢查項目' : 'Enter exam items';
  
  
  // Left Card 3
  String get referringPhysician => isZh ? '轉診醫師' : 'Referring Physician';
  String get selectDoctorLabel => isZh ? '醫師：' : 'Doctor:';
  String get otherDoctorLabel => isZh ? '其他醫師：' : 'Other Doctor:';
  String get enterDoctorName => isZh ? '請填寫醫師姓名' : 'Please enter doctor name';
  String get departmentLabel => isZh ? '科別：' : 'Department:';
  String get otherDepartmentLabel => isZh ? '其他科別：' : 'Other Department:';
  String get enterDepartmentName => isZh ? '請輸入科別' : 'Enter department';
  String get doctorSignatureLabel => isZh ? '醫師簽名：' : 'Doctor Signature:';
  
  // Left Card 4
  String get appointmentDept => isZh ? '安排就醫科別：' : 'Appointment Dept:';
  String get optionalDept => isZh ? '選填就醫科別' : 'Optional dept';
  String get optionalRoom => isZh ? '選填就醫診間' : 'Optional room';
  String get appointmentNo => isZh ? '安排就醫號碼：' : 'Appointment No:';
  String get optionalNumber => isZh ? '選填就醫號碼' : 'Optional number';
  
  // Right Card 4
  String get referralHospitalName => isZh ? '建議轉診院所名稱：' : 'Referral Hospital:';
  String get referralDepartment => isZh ? '建議院所科別：' : 'Referral Dept:';
  String get referralDoctorName => isZh ? '建議院所醫師姓名：' : 'Referral Doctor:';
  String get optionalReferralDoctor => isZh ? '視情況填寫轉診院所醫師' : 'Optional';
  String get hospitalAddress => isZh ? '建議院所地址：' : 'Hospital Address:';
  String get hospitalPhone => isZh ? '建議院所電話：' : 'Hospital Phone:';
  
  // Left Card 5 - Consent Section
  String get consentSignatureLabel => isZh ? '同意人簽名：' : 'Consent Signature:';
  String get relationToPatient => isZh ? '與病人關係：' : 'Relation to Patient:';
  String get enterRelationToPatient => isZh ? '請填寫同意人與病人關係' : 'Please enter relation to patient';
  String get signatureDate => isZh ? '簽名日期：' : 'Signature Date:';
}
