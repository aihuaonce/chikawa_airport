            ...
            children: [
              pw.TableRow(
                children: [
                  ...
                  cell('基\n本\n資\n料', bold: true, align: pw.Alignment.center),
                  pw.Container(
              ...
              pw.TableRow(
                children: [
                  cell(''),
                  cell('病\n歷\n摘\n要', bold: true, align: pw.Alignment.center),
                  pw.Container(
              ...
              pw.TableRow(
                children: [
                  cell(''),
                  cell('轉\n診\n目\n的', bold: true, align: pw.Alignment.center),
                  pw.Container(
                    padding: const pw.EdgeInsets.all(4),
                    width: contentWidth - 14,
                    child: pw.Row(
                      ...
                      children: [
                        pw.Container(
                          ...
                          child: pw.Column(
                            ...
                            children: [
                              pw.Row(
                                children: [chk(d.purposeEmergency, '1. 急診治療')],
                              ),
                              pw.SizedBox(height: 2),
                              pw.Row(
                                children: [chk(d.purposeHospital, '2. 住院治療')],
                              ),
                              pw.SizedBox(height: 2),
                              pw.Row(
                                children: [chk(d.purposeClinic, '3. 門診治療')],
                              ),
                            ],
                          ),
                        ),
                      ...
                      children: [
                        ...
                        pw.Row(
                          children: [
                            ...
                            pw.Text(
                              '年',
                              style: ts(c: const PdfColor.fromInt(0xFFC0392B)),
                            ),
              ...
              pw.TableRow(
                children: [
                  cell(''),
                  cell('診\n治\n醫\n師', bold: true, align: pw.Alignment.center),
                  pw.Container(
                    padding: pw.EdgeInsets.zero,
                    width: contentWidth - 14,
                    child: pw.Column(
